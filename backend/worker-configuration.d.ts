/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 8e7e6eb6548b11e42558085119d4abda)
// Runtime types generated with workerd@1.20260708.1 2026-07-13 
interface __BaseEnv_CloudflareBindings {
	DISPLAY_ROOM: DurableObjectNamespace<import("./src/index").DisplayRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DisplayRoom";
	}
